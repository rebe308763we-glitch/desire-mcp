...
async def oauth_authorize(request: Request, response_type: str = "code",
...
async def _mcp_post_message(scope, receive, send):
    await sse_transport.handle_post_message(scope, receive, send)


app.router.routes.append(Route("/mcp", endpoint=_mcp_sse_endpoint, methods=["GET"]))
app.router.routes.append(Route("/mcp/messages/", endpoint=_mcp_post_message))
